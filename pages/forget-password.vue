<template>
    <div class="w-full h-[100vh] flex items-center justify-center">
      ...
      >
        <div
          v-if="!OTPCheck"
          class="flex flex-row gap-10 justify-center items-center"
        >
          <div class="text-2xl text-black-primary rounded-xl w-[450px]">
            <div class="rounded-2xl flex items-center justify-center relative">
              <img :src="BannerLogin" alt="Banner Login" class="absolute h-[405px] w-[450px] rounded-2xl object-cover" />
            </div>
          </div>
          <div class="flex flex-col">
            <LoginLogo class="w-20 object-left" />
            <div class="text-3xl text-black-primary font-semibold -mt-4">
              Reset password
            </div>
            <div class="text-base text-black-primary mb-4">
  ...
  import BannerLogin from "@/components/images/BannerPassword.png";
