        ...
        <div v-if="user != null">
          ...
          >
            ...
            >
              ...
              <div class="flex flex-col">
                <div
                  class="flex flex-row border border-grey-primary rounded-xl"
                >
          ...
          >
            ...
            <div class="flex flex-col gap-1 min-w-64 mt-2">
              ...
              <div v-if="editMode" class="flex flex-col gap-2">
                ...
                >
                  <div
                    class="p-3 border border-grey-tertiary rounded-xl w-full"
                  >
                    <select
              ...
              <div class="flex flex-row gap-4 mb-2">
                ...
                >
                  <select
                    ...
                    class="bg-transparent border-none focus:ring-0 outline-none text-base pr-2 hover:cursor-pointer"
                  >
                    <option value="">All Serms</option>
                    <option
                      v-for="option in sermOptions"
                      :key="option.id"
                      :value="option.id"
                    >
                ...
                >
                  <div class="flex flex-row justify-between gap-6 items-center">
                    <button @click="overviewCourse(course.id)">
                      <p
                        class="text-base text-start font-semibold text-grey-600"
                      >
                        {{ course.code }}
                      </p>
...
onMounted(() => {
  ...
  fetchPrograms(programOptions);
  fetchSerms(sermOptions);
});
