        ...
        >
          <div class="flex flex-col w-[28rem] pb-2 border-b border-grey-secondary">
            ...
            <div class="text-sm text-grey-primary mt-1">
              from course
              <span class="font-semibold text-black-primary">{{ courseName }}</span>
            </div>
          </div>
          ...
          <div class="flex flex-row items-center justify-center gap-2 w-full mt-4 rounded-xl">
            <button
              @click="confirmDelete"
              class="py-2 font-medium border border-grey-secondary  text-white rounded-xl w-full bg-red-500 hover:bg-black-primary hover:text-white"
            >
              Delete
            </button>
            <button
